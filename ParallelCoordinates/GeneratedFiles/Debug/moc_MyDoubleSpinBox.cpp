...
QT_MOC_LITERAL(1, 16, 12), // "sendIntValue"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "value"
QT_MOC_LITERAL(4, 36, 11), // "setIntValue"
QT_MOC_LITERAL(5, 48, 11) // "getIntValue"

    },
    "MyDoubleSpinBox\0sendIntValue\0\0value\0"
    "setIntValue\0getIntValue"
};
...
void MyDoubleSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendIntValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setIntValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->getIntValue((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyDoubleSpinBox::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyDoubleSpinBox::sendIntValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyDoubleSpinBox::sendIntValue(int _t1)
{
